...
export default function ResetPassword() {
  ...
  const doPasswordsMatch = confirm.length > 0 && pwd === confirm;
  ...
  const onSubmit = async (e) => {
    ...
    setMsg("");
    try {
      const res = await resetPassword(code, pwd, confirm);
      // success: store JWT and bounce to /home
  ...
  return (
    <div className="hero-wrap">
      ...
      <div className="center">
        ...
        <div className="sub">Create a new password for your account</div>

        <section className="card" aria-label="Reset Password">
          ...
          {msg && (
            <div
              className={`message ${
                /reset!|redirecting/i.test(msg) ? "success" : "error"
              }`}
            >
              {msg}
            </div>
